...
```
## Extra Lexicon and visualizations
...
```{r, message=FALSE,, include = TRUE, fig.cap = "Comparison of sentiment ratings based on lexicon. Each bar represents the sum of word sentiments in groups of 25 lines. Note that around index 250 (or around line 6250) there is a distinct group of negiive sentiments identified in all four lexicons.",fig.width=7.5, fig.height=7.5/1.682}
...
```{r, fig.cap="Timeline of sentence sentiment colored by character occurance", fig.width=7.5, fig.height=7.5/1.682, include = TRUE}
...
```{r fig.cap = "Co-occurance of character's sentiment histogram", fig.width=7.5, fig.height=7.5/1.682, include = TRUE}
