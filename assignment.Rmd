...
```{r, message=FALSE,, include = TRUE, fig.cap = "Comparison of sentiment ratings based on lexicon. Each bar represents the sum of word sentiments in groups of 25 lines. Note that around index 250 (or around line 6250) there is a distinct group of negiive sentiments identified in all four lexicons.",fig.width=6.5, fig.height=5}
